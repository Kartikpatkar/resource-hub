...
- Getting Things Done
  ...
  Notes: Framework for capturing tasks and reducing mental overhead.

- Pomofocus
  Link: https://pomofocus.io
  Category: Tool
  Tags: productivity, focus, time-management
  Notes: Lightweight Pomodoro timer for structured focus sessions.
...
- Obsidian
  ...
  Notes: Local-first note-taking tool useful for linked thinking and research.
...
- tmux
  ...
  Category: Tool
  Tags: terminal, workflow, productivity
  Notes: Terminal multiplexer for durable multi-session command-line workflows.
